...
public class CardCurentAdapter extends RecyclerView.Adapter<CardCurentAdapter.CardViewHolder> {
    ...
    public CardCurentAdapter(List<ContBancar> conturi, OnCardSelected listener) {
    ...
    public CardViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_card_curent, parent, false);
    ...
    public void onBindViewHolder(@NonNull CardViewHolder holder, int position) {
        ...
        holder.tvTip.setText(cont.getTipCard());
        ...
        holder.itemView.setOnClickListener(v -> {
            ...
            if (listener != null) listener.onCardSelected(cont);
        });
    }
    ...
    static class CardViewHolder extends RecyclerView.ViewHolder {
        TextView tvNumeBanca, tvNumar, tvSold, tvTip;
        ...
        public CardViewHolder(@NonNull View itemView) {
            ...
            tvTip = itemView.findViewById(R.id.tvTipCard);
        }
    }
}